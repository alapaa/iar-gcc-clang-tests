...
$CC -I ./ra_gen/  -O0 -fverbose-asm -S src/perf_meas_loop.c -o ${O_0_FILE}
$CC -I ./ra_gen/  -Os -fverbose-asm -S src/perf_meas_loop.c -o ${O_s_FILE}
$CC -I ./ra_gen/  -O2 -fverbose-asm -S src/perf_meas_loop.c -o ${O_2_FILE}
echo "Done!"
